...
- Extensive documentation improvements.  Plugin docs install to /usr/local/share/doc/packages/automotive-message-broker/plugins/.
- Bluemonkey JS API docs /usr/local/share/doc/packages/automotive-message-broker/plugins/bluemonkey/html/.
